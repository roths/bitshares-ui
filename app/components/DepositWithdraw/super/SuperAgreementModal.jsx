...
class SuperAgreementModal extends React.Component {
    static propTypes = {
                ...
                return (
                    ...
                    >
                        ...
                        <p>
                            ...
                            是一家根据新加坡共和国法律成立的公司，Super是由该公司运营的比特股网关(以下称“Super”或“本网关”)，主访问入口为https://www.Super.io，Super是一个在比特股平台为用户提供数字资产充提服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网关在本协议中合称使用“我们”或其他第一人称称呼。使用该服务的自然人或其他主体均为本网关的用户，本协议为表述之便利，以下使用“您”或其他第二人称。我们和您在本协议中合称为“双方”，我们或您单称为“一方”。
                        </p>
                        <p>重要提示：</p>
                        <p>我们在此特别提醒您：</p>
                        <p>
                        ...
                        <p>敬告您：</p>
                        <p>
                            1.您了解比特股是基于区块链的去中心化交易平台，其基础账号服务和交易撮合服务都由比特股平台提供。亦有其它机构或个人在比特股平台上发行资产及／或提供服务。您了解本网关仅作为您向比特股平台充提数字资产的工具。本网关只对自身发行的交易代币资产（名称以Super.为前缀）负责，不对比特股上其它机构或个人发行的资产负责，本网关不参与您的任何交易，您应自行谨慎判断确定相关数字资产及/或信息的真实性、合法性和有效性，并自行承担因此产生的责任与损失。
                        </p>
                        <p>
                            {" "}
                            2.
                ...
                return (
                    ...
                    >
                        ...
                        <p>
                            ...
                            the availability of own issued assets (with 'Super.'
...
export default connect(SuperAgreementModal, {
    listenTo() {
