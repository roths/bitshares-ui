...
import {getTransactionRecordList} from "../../../lib/common/superMethods";
import ChainTypes from "../../Utility/ChainTypes";
import BindToChainState from "../../Utility/BindToChainState";
import {precisionToRatio} from "../../../lib/common/MarketClasses";
...
class SuperHistory extends React.Component {
    static propTypes = {
        ...
        getTransactionRecordList(
            ...
            .then(records => {
                ...
                records.forEach(item => {
                    allData[item.order_no] = {
                        txid: item.order_no,
                        amount: item.amount,
                        time: new Date(item.timestamp),
                        unixtime: new Date(item.timestamp),
                        status: [
                            "gateway",
                            historyStatusType,
                ...
                _this.setState({
                    ...
                    nextPageEnabled: records.length > pageNum * pageSize,
                    allData: allData,
                    pageNum: pageNum,
    ...
    render() {
        let {assetName, compactView, style, maxHeight, asset} = this.props;
                      ...
                      <tr key={o.txid}>
                          ...
                          >
                              <Translate
                                  ...
                                  amount={
                                      o.amount /
                                      precisionToRatio(asset.get("precision"))
                                  }
                                  assetName={assetName}
                                  txid={o.txid}
                              />
...
export default BindToChainState(SuperHistory);
