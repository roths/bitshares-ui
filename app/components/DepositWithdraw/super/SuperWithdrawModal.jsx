...
import {validateAddress, WithdrawAddresses} from "common/superMethods";
...
class SuperWithdrawModal extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            withdraw_address: WithdrawAddresses.getLast(props.outerSymbol),
    ...
    componentWillReceiveProps(np) {
        if (np.outerSymbol != this.props.outerSymbol) {
            this.setState({
                withdraw_address: WithdrawAddresses.getLast(np.outerSymbol),
                withdraw_address_selected: WithdrawAddresses.getLast(
                    np.outerSymbol
                )
            });
    ...
    _assembleMemo() {
        return this.props.outerSymbol + ":" + this.state.withdraw_address;
    }
    ...
    _validateAddress(new_withdraw_address, props = this.props) {
        validateAddress({
            ...
            .catch(err => {
                ...
                if (!err.code) message = "System error: please try again later";
                else message = "address not valid";
                this.setState({
                    withdraw_address_check_in_progress: false,
                    withdraw_address_is_valid: null,
    ...
    onSubmit() {
        if (
            ...
            if (!this.state.withdraw_address_is_valid) {
                ...
                if (!WithdrawAddresses.has(this.props.outerSymbol)) {
                    let withdrawals = [];
    ...
    onSubmitConfirmation() {
        ...
        if (!WithdrawAddresses.has(this.props.outerSymbol)) {
            ...
            let withdrawals = WithdrawAddresses.get(this.props.outerSymbol);
    ...
    render() {
        ...
        let storedAddress = WithdrawAddresses.get(this.props.outerSymbol);
        let balance = null;
                    ...
                    invalid_address_message = (
                        <div className="has-error" style={{paddingTop: 10}}>
                            <Translate
                                ...
                                coin_type={this.props.outerSymbol}
                            />
                        </div>
                    );
                }
                    ...
                    <div className="content-block">
                        <h3>
                            <Translate
                                ...
                                coin={this.props.outerSymbol}
                                symbol={this.props.outerSymbol}
                            />
                        </h3>
                    </div>
                            ...
                            <div className="inline-label input-wrapper">
                                ...
                                <div className="form-label select floating-dropdown">
                                    <div className="dropdown-wrapper inactive">
                                        <div>{this.props.outerSymbol}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default BindToChainState(SuperWithdrawModal, {keep_updating: true});
