...
class SuperWithdrawModal extends React.Component {
    ...
    _assembleMemo(){
        ...
        return "withdraw:" + this.state.memo;
    }
    ...
    onSubmit() {
        if ((this.state.withdraw_amount !== null) && !!this.state.memo) {
            if (parseFloat(this.state.withdraw_amount) > 0){
    ...
    render() {
        ...
        let submitDisable = this.state.empty_withdraw_value ||
                    this.state.below_minumum_withdraw_value ||
                    this.state.memo_error || this.state.error || this.state.balanceError;

        if (this.props.output_supports_memos) {
            withdraw_memo =
				<div className="content-block">
					<label><Translate component="span" content="transfer.memo"/></label>
					<textarea placeholder="备注姓名以及支付宝账号或银行卡号" style={{"resize": "none"}} rows="1" value={memo} tabIndex={tabIndex++} onChange={this.onMemoChanged.bind(this)} />
            ...
            <div className="grid-container">
                ...
                {this.state.feeAmount ? <div className="content-block gate_fee">
                    <AmountSelector
                        ...
                        assets={[this.state.feeAmount.asset_id]}
                        tabIndex={tabIndex++}
                    />
                ...
                <div className="button-group">
                    ...
                    <div onClick={this.onSubmit.bind(this)} className={"button" + (submitDisable ? (" disabled") : "")}>
